...
await Ryuu.setStatus(`${botname} | Ketik .menu | ⏲️ Bot Telah Aktif Selama : ${uptimer}`).catch((_) => _);
...
const daftar3 = [{buttonId: `${prefix}verify`,buttonText: {displayText: `✒️ VERIFY 📃`,},type: 1,},]
...
reply('🌱 _*Success Aktif Senpai*_ 🌱')
} else if (Number(args[0]) === 0) {
event.splice(from, 1)
fs.writeFileSync('./lib/data/event.json', JSON.stringify(event))
reply('🌱 _*Sudah Dinonaktifkan Senpaii*_ 🌱')
} else {
reply('eeee')
}
break
